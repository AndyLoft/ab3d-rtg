...
.bug2: 
 ...
 move.w ymouse,d3;AL
 sub.w oldymouse,d3;AL
 add.w d3,oldymouse;AL
 asr.w #1,d3
 cmp.w #50,d3
 ble.s nofastfor
 move.w #50,d3
...
.nohalve
 ...
 move.w d1,d2
; add.w PLR1_bobble,d1;AL
 and.w #8190,d1
; move.w d1,PLR1_bobble;AL
...
; sub.l d1,d6
; sub.l d2,d7
; add.l d6,PLR1s_xspdval;AL
; add.l d7,PLR1s_zspdval;AL
; move.l PLR1s_xspdval,d6;AL
; move.l PLR1s_zspdval,d7;AL
; add.l d6,PLR1s_xoff;AL
; add.l d7,PLR1s_zoff;AL
...
.bug2: 
 ...
 ;tst.b (a5,d5.w)
 ;btst #6,$bfe001; LEFT mouse click
 btst   #2,$dff016   ; Right mouse click
 bne.s noforward
 neg.w d2
 move.w d2,d3
