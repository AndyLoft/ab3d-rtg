...
.noless:
 ...
 move.l #40*256,StepDownVal
 move.l #456*128,thingheight
 move.l #4,deadframe
...
; bsr ViewpointToDraw	;AL
 jsr ViewpointToDraw	;AL
...
; bsr CheckTeleport	;AL
 jsr CheckTeleport	;AL
 tst.b OKTEL
 beq.s .notel
 move.l floortemp,d0
 asr.l #7,d0
...
.notel:
 ...
 move.w #%110111100001,CollideFlags
 jsr Collision
 tst.b hitwall
 beq.s .canmove
...
BigRedThingAttack:
 ...
 btst #0,17(a0)
 beq BigRedThingAttackPLR2
 btst #1,17(a0)
 beq BigRedThingAttackPLR1
