...
; move.l #INTROTUNENAME,a0;AL
; jsr _LoadModule;AL
; move.l d0,INTROTUNEADDR;AL
 PRSDY
; move.l d0,a0;AL
; jsr _InitModule;AL
 
; move.l INTROTUNEADDR,a0;AL
; jsr _PlayModule;AL
;ProtChkFLev1:	;AL
 PRSDa
 bsr LOADTITLESCRN
...
; FLASHER $0f0,$fff
 ...
 IFEQ CD32VER 
; bsr ASKFORDISK	;AL REMOVED FOR NOW
 ENDC
 IFNE CD32VER
 PRSDD
 ENDC
...
;ProtChkILev1:	;AL
; move.l #RealTable-2000,a3	;AL
; move.l #PROTCALC-5000,a1	;AL
; move.l #ASKFORPROT-10000,a2	;AL
; move.l #PROTCALLENC-800,a4	;AL
; adda.w #800,a4	;AL
; jsr (a4)	;AL
...
;      0123456789012345678901234567890123456789
 ...
 dc.b '                                        ' ;5
KEY_LINES:
 dc.b '     TURN LEFT                MOUSE L   ' ;6
 dc.b '     TURN RIGHT               MOUSE R   ' ;7
 dc.b '     FORWARDS                   RMB     ' ;8
 ...
 dc.b ' PLASMA GUN       3                     ' ;3 ;MOUSE CONTROL    M ' ;3
 dc.b ' GRENADE LAUNCHER 4                     ' ;4 ;JOYSTICK CONTROL J ' ;4
 dc.b ' ROCKET LAUNCHER  5                     ' ;5 ;KEYBOARD CONTROL K ' ;5
 dc.b '                                        ' ;6
 dc.b '               MAIN  MENU               ' ;7
 dc.b '                                        ' ;8
 dc.b '                                        ' ;9
...
PROTCALLENC:
; incbin "ab3:source2/protcallenc.bin"	;AL
...
; include "ab3:source/protcallenc"	;AL
