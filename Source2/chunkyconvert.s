...
GetPensForCopCol:
	...
	jsr	-552(a6)				; OpenLibrary(), could also be -$228
	beq.w	Error
	move.l	d0,a6
	move.l	a6,GFXbase
...
.mc_bluloop:	movem.l	d1-3,-(a7)
	...
	moveq	#-1,d4
	jsr -1008(a6);CALLA6	FindColor		;d0=best matching pen number
	...
	jsr -576(a6);CALLA6	FreeColorMap
...
.cc_loop:	move.w	(a0)+,d1		;d1=12bit colour
	...
	move.l	d0,a6
	move.l	a6,GFXbase
	jsr -786(a6);GRAFCALL	WritePixelArray8
